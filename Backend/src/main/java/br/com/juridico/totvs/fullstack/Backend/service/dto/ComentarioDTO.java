...
public class ComentarioDTO {
    ...
    public ComentarioDTO(Long id, Long pontoTuristicoId, String descricao, String nomeDoAutor, LocalDateTime dataDaCriacao) {
        this.id = id;
    ...
    public ComentarioDTO(Comentario comentarioDTO) {
